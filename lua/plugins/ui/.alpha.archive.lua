  ...
  -- the banner.
  {
    ...
    config = function()
      ...
      dashboard.section.buttons.val = {
        ...
        button("w",     " " .. " Find Word",         "<cmd>lua require('plugins.telescope.multi-rg')()<CR>", {}),
        button("h",     " " .. " Recents",           "<cmd>Telescope oldfiles hidden=true<CR>", {}),
        -- button("l",     " " .. " Load Last Session", "<cmd>SessionManager load_last_session<CR>", {}),
        button("u",     "󰏔 " .. " Update Plugins",    "<cmd>Lazy update<CR>", {}),
        button("m",     "󰏓 " .. " Manage Plugins",    "<cmd>Lazy<CR>", {}),
        button("s",     " " .. " Settings",          "<cmd>e $MYVIMRC<CR>", {}),
        button("<ESC>", " " .. " Exit",              "<cmd>exit<CR>", {}),
      }
